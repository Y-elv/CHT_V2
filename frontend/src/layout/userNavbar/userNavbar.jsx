      ...
      <div className="container-fluid px-10">
        ...
        >
          ...
          <div className="links flex flex-col items-start justify-start  gap-3 my-5 w-full">
            ...
            {/* <div
              className="nav-link text-black text-sm relative group w-full"
              to="/services"
            >
              <p>Services</p>
              <div className="hidden absolute left-[-20%] w-[70%] group-hover:flex flex-col gap-2 bg-white border border-l-gray-500 rounded p-2  transition-all shadow-md">
                <Link
                  className="nav-link text-black text-sm p-1 rounded hover:bg-gray-100"
                  to="/hospital"
                >
                  Hospital
                </Link>
            ...
            <Link className="nav-link text-black text-sm" to="/news">
              News
            </Link>
          </div>
          ...
          <div className="links flex flex-col items-start justify-start  gap-1 my-2">
            <Link
              ...
              to="/login"
              className="px-4 py-2 w-full bg-blue-400 hover:bg-blue-600 rounded-md"
            >
              Logout
            </Link>
          </div>
        ...
        <div className="hidden tablet:flex items-center gap-3">
          ...
          <Link
            className=" hidden tablet:flex iconn"
